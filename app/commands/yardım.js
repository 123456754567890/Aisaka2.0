...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    .setAuthor({ name: "StarBot Yardım Menüsü", iconURL: client.user.displayAvatarURL({ dynamic: true })})
    .setTitle("・Hangi komutlarım hakkında bilgi almak istiyorsan o butona bas!")
    .setDescription("\n\n** Linkler**\n> ・**Botun davet linki: [Tıkla](https://discord.com/api/oauth2/authorize?client_id=1162475363696377957&permissions=8&scope=bot)**\n> ・**Botun destek sunucusu: [Tıkla](https://discord.gg/xRvBG8acbH)**\n> ・**Botun gizlilik politikası: [Tıkla](https://discord.com/api/oauth2/authorize?client_id=1162475363696377957&permissions=8&scope=bot)**")
    .setColor('Blue')
